      ...
      <div>
        ...
        <section className="ct_py_70 ">
          <div className="container">
            <div className="ct_full_poll_page_bg">
                                    ...
                                    <div className="d-flex  gap-3 ">
                                      ...
                                      <div style={{ flex: "1" }}>
                                        ...
                                        <p className="ct_fs_13 mb-0  ct_ff_roboto ct_line_height_22 ct_commented_text mt-3">
                                          <span>
                                            Design Shot is an invitation to
                                            ponder cn design as a living entity.
                                            capture of embodying and influencing
                                            the flow of thoughts and sensations
                                            in
                                          </span>
                                        </p>
                                      </div>
