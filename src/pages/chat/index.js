                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="d-flex align-items-center justify-content-between gap-3  mb-3 ct_flex_col_575">
                                ...
                                <ul className="nav nav-pills mb-3 ct_custom_tabs mt-0" id="pills-tab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link active" id="pills-public-info-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-public-info" type="button" role="tab" aria-controls="pills-public-info"
                                            aria-selected="true">Connections</button>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link" id="pills-persional_info-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-persional_info" type="button" role="tab"
                                            aria-controls="pills-persional_info" aria-selected="false" tabindex="-1">Discover</button>
                                    </li>
                                </ul>
                            </div>
                            <div className="tab-content" id="pills-tabContent">
                                <div className="tab-pane fade active show" id="pills-public-info" role="tabpanel"
                                            ...
                                            <div className="modal-dialog-scrollable ">
                                                <div className="modal-content ">
                                                    <div
                                                        ...
                                                        <h4 className="ct_fs_16 mb-0 ct_fw_600 ct_nunito_font ct_text_op_05">34</h4>
                                                    </div>
                                                    <div className="position-relative">
                                                        <input type="text"
                                                            className="form-control ct_input ct_input_ps_40 ct_input_h_40 ct_border_op_10" placeholder="Search" />
                                                                    ...
                                                                    <div className="ct_chat_list_grid">
                                                                        ...
                                                                        <div className="flex-grow-1 ms-3">
                                                                            <div
                                                                                ...
                                                                                <h3 className="ct_fs_16 ct_fw_600">Jane Doe
                                                                                </h3>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <p
                                                                                    ...
                                                                                    Hi, i want make enquiries about yo...</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-2 ">
                                                                        ...
                                                                        <div className="ct_grid_50_auto">
                                                                            <img src="assets/img/user.png" alt="" data-bs-target="#full_view_img" data-bs-toggle="modal" />
                                                                            <div>
                                                                        ...
                                                                        <ul>
                                                                                ...
                                                                                <div>
                                                                                    <div className="sender">
                                                                                        <h5 className="ct_fs_16  mb-2 ">
                                                                                            Hey, I have a question about my recent order #12345. When can I expect it to be delivered?
                                                                                        </h5>
                                                                                    </div>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="repaly">
                                                                                    <p>Hi John, your order is currently in transit
                                                                                        and
                                                                                        should arrive within 2-3 business days. You
                                                                                        can
                                                                                        track it using the tracking number sent to
                                                                                        your
                                                                                        email.</p>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="sender">
                                                                                    <h5 className="ct_fs_16  mb-2 ">
                                                                                        ...
                                                                                        #12345. When can I expect it to be
                                                                                        delivered?
                                                                                    </h5>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="repaly">
                                                                                    <p>
                                                                                        Hi John, your order is currently in transit
                                                                                        and
                                                                                        should arrive within 2-3 business days. You
                                                                                        can
                                                                                        track it using the tracking number sent to
