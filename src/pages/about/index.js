              ...
              <div className="col-md-12">
                <div className="text-center">
                  <h2 className="mb-3 fw-bold">
                    {" "}
                    You are welcome Join the Club
                  </h2>
                  <p className="mb-0">You are welcome Join the Club</p>
                  <p className="mb-0">
                    Where Men Think Boldly. Dive into unfiltered ideas, sharp
                    debates, and conversations that matter. The door is open-you
                    are welcome!.{" "}
                  </p>
                </div>
              </div>
