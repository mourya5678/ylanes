...
export const authSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        // getMyProfileDatass
        builder.addCase(getMyProfileDatass.pending, (state, action) => {
            // state.isLoading = true;
        });
        builder.addCase(getMyProfileDatass.fulfilled, (state, action) => {
            // state.isLoading = false;
        });
        builder.addCase(getMyProfileDatass.rejected, (state, action) => {
            // state.isLoading = false;
        });
        ...
        // deleteAccountByOTP
        builder.addCase(deleteAccountByOTP.pending, (state, action) => {
            state.isLoading = true;
        });
        builder.addCase(deleteAccountByOTP.fulfilled, (state, action) => {
            state.isLoading = false;
        });
        builder.addCase(deleteAccountByOTP.rejected, (state, action) => {
            state.isLoading = false;
        });
